...
import koray from "../../public/assets/img/koray.jpg";
        ...
        >
          ...
          <Stack justifyContent="centre" alignItems="center">
            <Stack justifyContent="centre" alignItems="center">
              ...
              <Typography color="white">Product Designer</Typography>
            </Stack>
          </Stack>
        </Stack>
      </Stack>
      ...
      <Stack paddingX="20px" paddingY="50px">
        {tabValue == 0 && (
          <Stack gap="20px">
              ...
              <Button
                ...
                onClick={() => {
                  window.location.href =
                    "https://mmcardsystem.online/userfiles/izzetyesil.vcf";
                }}
            ...
            <Link href="mailto:bloodkeyz@gmail.com">
              <Stack
                width="100%"
                height="37px"
                flexDirection="row"
        ...
        {tabValue == 1 && (
          <Stack flexDirection="row" flexWrap="wrap" gap="20px">
            <Link target="_blank" href="https://www.instagram.com/izze.t">
              <Stack
                width="150px"
                paddingTop="10px"
                height="150px"
              ...
              <Stack
                onClick={() => {
                  navigator.clipboard.writeText(
                    "TR98 0001 0021 8585 2556 0450 01"
                  );
                  alert("kopyalandı");
                }}
              >
